...
export async function PATCH(request: Request, context: Context) {
  try {
    ...
    const data = await adminResources.testimonials.update(id, input)
    return successResponse(data)
  } catch (error) {
    return errorResponseFrom(error, 'Unable to update testimonial')
  }
}
...
export async function DELETE(_request: Request, context: Context) {
  try {
    ...
    const { id } = await context.params
    const data = await adminResources.testimonials.remove(id)
    return successResponse(data)
  } catch (error) {
    return errorResponseFrom(error, 'Unable to delete testimonial')
  }
}
