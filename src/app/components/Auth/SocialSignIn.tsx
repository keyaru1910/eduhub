        ...
        <>
            <div className='flex gap-4'>
                <button
                    ...
                    className='flex w-full items-center justify-center gap-2.5 rounded-lg border border-gray-200 p-3.5 text-black hover:cursor-pointer hover:bg-neutral-100 dark:border-white/10 dark:text-white dark:hover:bg-slate-800'>
                    Đăng nhập
                    <svg
                        width='23'
                        height='22'
